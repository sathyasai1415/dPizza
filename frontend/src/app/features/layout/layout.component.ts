  ...
  template: `
    <div class="min-h-screen flex text-white bg-[#0A0D18] relative">
      ...
      <aside [class.translate-x-0]="sidebarOpen()" [class.-translate-x-full]="!sidebarOpen()"
        class="fixed top-0 bottom-0 left-0 z-40 w-64 flex flex-col transition-transform duration-300 lg:translate-x-0 border-r border-white/10 bg-[#07070d]/80 backdrop-blur-md">
