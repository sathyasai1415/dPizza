...
@Component({
  ...
  template: `
    <div class="max-w-4xl mx-auto py-8 space-y-8">
      <h1 class="text-3xl font-black text-brand-black tracking-tight">📄 Legal Information</h1>

      <!-- Terms of Service -->
      <div class="clay rounded-3xl p-8 space-y-4">
        <h2 class="text-xl font-black text-brand-black border-b border-brand-black pb-3">Terms of Service</h2>
        <p class="text-xs text-brand-black font-medium">Last updated: July 9, 2026</p>

        <div class="space-y-4 text-sm text-brand-black leading-relaxed">
          ...
          <h3 class="text-base font-bold text-brand-black pt-2">1. Service Description</h3>
          ...
          <h3 class="text-base font-bold text-brand-black pt-2">2. User Accounts</h3>
          ...
          <h3 class="text-base font-bold text-brand-black pt-2">3. Orders & Payments</h3>
          ...
          <h3 class="text-base font-bold text-brand-black pt-2">4. Restaurant Partners</h3>
          ...
          <h3 class="text-base font-bold text-brand-black pt-2">5. Limitation of Liability</h3>
          ...
          <h3 class="text-base font-bold text-brand-black pt-2">6. Changes to Terms</h3>
      ...
      <!-- Privacy Policy -->
      <div class="clay rounded-3xl p-8 space-y-4">
        <h2 class="text-xl font-black text-brand-black border-b border-brand-black pb-3">Privacy Policy</h2>
        <p class="text-xs text-brand-black font-medium">Last updated: July 9, 2026</p>

        <div class="space-y-4 text-sm text-brand-black leading-relaxed">
          <h3 class="text-base font-bold text-brand-black pt-2">1. Information We Collect</h3>
          ...
          <h3 class="text-base font-bold text-brand-black pt-2">2. How We Use Your Information</h3>
          <ul class="list-disc list-inside space-y-1">
          ...
          <h3 class="text-base font-bold text-brand-black pt-2">3. Data Sharing</h3>
          ...
          <h3 class="text-base font-bold text-brand-black pt-2">4. Data Security</h3>
          ...
          <h3 class="text-base font-bold text-brand-black pt-2">5. Your Rights</h3>
          <p>You may request deletion of your account and data at any time by contacting support&#64;mislice.online.</p>

          <h3 class="text-base font-bold text-brand-black pt-2">6. Contact</h3>
          <p>For privacy inquiries, email: <span class="text-brand-red">support&#64;mislice.online</span></p>
        </div>
      </div>

      <!-- Cookie Policy -->
      <div class="clay rounded-3xl p-8 space-y-4">
        <h2 class="text-xl font-black text-brand-black border-b border-brand-black pb-3">Cookie Policy</h2>
        <div class="text-sm text-brand-black leading-relaxed space-y-3">
