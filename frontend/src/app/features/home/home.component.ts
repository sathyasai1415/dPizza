...
@Component({
    ...
    <div class="home">
      ...
      <div class="ticker">
        <div class="track">
          ...
          <span>🏷️ <b>Zumbo's Pizza:</b> Buy One Get One Free</span>
          <span>⚡ <b>Motor City Slice:</b> Free delivery over $20</span>
          <span>🔥 <b>Great Lakes Pies:</b> 30% off all deep dish</span>
          <span>💰 <b>Bunty's Pizza:</b> $5 off any XL pizza</span>
          <span>🍕 <b>Rambo's Pizza:</b> Detroit combo just $18.99</span>
          <span aria-hidden="true">🍕 <b>Shamz Pizza:</b> Large Pepperoni now $11.99</span>
          <span aria-hidden="true">🏷️ <b>Zumbo's Pizza:</b> Buy One Get One Free</span>
          <span aria-hidden="true">⚡ <b>Motor City Slice:</b> Free delivery over $20</span>
        </div>
      </div>
      ...
      <!-- Top menu -->
      <div class="sechd"><h2>Trending</h2><span class="sub">Most popular in Michigan</span></div>
      <div class="list">
  ...
  styles: [`
    ...
    .promo{position:relative; overflow:hidden; border-radius:22px; padding:26px 24px; color:#fff;
      background:linear-gradient(135deg, #1E053D 0%, #0E011E 100%);
    ...
    .sechd h2{font-weight:800; font-size:18px; letter-spacing:-.01em; color:var(--gold);}
    ...
    .cat .b{width:60px; height:60px; border-radius:19px; background:var(--surface); border:1px solid var(--line);
      display:grid; place-items:center; font-size:26px; transition:.16s; box-shadow:0 6px 14px -10px rgba(0,0,0,0.5);}
    ...
    .food{background:var(--surface); border:1px solid var(--line); border-radius:20px; overflow:hidden; display:flex; flex-direction:column;
      box-shadow:0 8px 20px -16px rgba(0,0,0,0.5); transition:transform .16s, box-shadow .16s;}
    .food:hover{transform:translateY(-3px); box-shadow:0 16px 28px -16px rgba(0,0,0,0.6);}
    .food .thumb{height:120px; position:relative; background:radial-gradient(circle at 50% 40%,#1E053D,#0E011E); display:grid; place-items:center;}
    ...
    .food h3{font-weight:800; font-size:14.5px; letter-spacing:-.01em; line-height:1.2; color:var(--ink);}
    ...
    .food .by{font-size:10.5px; font-weight:700; color:var(--gold); opacity:0.8; text-transform:uppercase; letter-spacing:.04em;}
    ...
    .food .was{font-size:12px; color:var(--muted); font-weight:700; text-decoration:line-through; opacity:0.6;}
    ...
    .litem{display:flex; gap:13px; background:var(--surface); border:1px solid var(--line); border-radius:18px; padding:15px;
      box-shadow:0 6px 16px -14px rgba(0,0,0,0.5);}
    ...
    .lm h4{font-weight:800; font-size:15px; letter-spacing:-.01em; color:var(--ink);}
    ...
    .qc{background:var(--warm); border:1px solid rgba(212,175,55,0.25); padding:8px 14px; border-radius:10px; font-weight:800; font-size:11.5px; color:var(--gold); cursor:pointer; font-family:inherit; transition:.2s;}
    .qc:hover{background:rgba(212,175,55,0.15); border-color:var(--gold);}
